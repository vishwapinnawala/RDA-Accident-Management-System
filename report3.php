...
<li>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 newro" style="width:100%;">
			    ...
			    <textarea class="form-control"  name="complain" rows="4" cols="50">Complain</textarea><br>
			    
                            <label class="form-label" for="customFile">Upload Images</label>
			    <input type="file" name="fileToUpload" id="fileToUpload" class="form-control" id="customFile" />
