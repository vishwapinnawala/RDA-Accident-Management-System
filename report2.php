 ...
 <img src="assets/images/users/avatar-1.jpg"   alt="" class="img-circle">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="report2.php" class="waves-effect"><i class="ti-ruler-pencil"></i><span> Report <span class="badge badge-primary pull-right">6</span></span></a>
                            </li>
<li>
                                <a href="report3.php" class="waves-effect"><i class="ti-ruler-pencil"></i><span> Complain <span class="badge badge-primary pull-right">6</span></span></a>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-3">
                                <div class="panel panel-primary text-center">
                                    ...
                                    <div class="panel-body">
                                        <h3 class=""><b>2568 <br><button type="button" class="btn btn-primary">Primary</button></b></h3>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="panel panel-primary text-center">
                                    ...
                                    <div class="panel-body">
                                        <h3 class=""><b>3685<br><button type="button" class="btn btn-primary">Primary</button></b></h3>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="panel panel-primary text-center">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">File a Complain</h4>
                                    </div>
                                    <div class="panel-body">
                                        <h3 class=""><b>25487<br><button type="button" class="btn btn-primary">Primary</button></b></h3>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="panel panel-primary text-center">
                                    ...
                                    <div class="panel-body">
                                        <h3 class=""><b>$2779.7<br><button type="button" class="btn btn-primary">Primary</button></b></h3>
